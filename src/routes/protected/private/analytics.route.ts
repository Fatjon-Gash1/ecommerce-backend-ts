...
router.get(
    ...
    validateId(),
    validationErrors,
    analyticsController.getTotalOrdersForCustomer.bind(analyticsController)
);
router.get(
...
router.get(
    ...
    validateInterval(),
    validationErrors,
    analyticsController.getConversionRate.bind(analyticsController)
);
router.get(
    '/rates/acquisitions',
    validateLeads(),
    validationErrors,
    analyticsController.getCustomerAcquisitionRate.bind(analyticsController)
);
router.get(
    '/rates/repeated-purchases',
    analyticsController.getRepeatPurchaseRate.bind(analyticsController)
);
router.get(
    '/rates/product/:id/add-to-cart',
    validateId(),
    validationErrors,
    analyticsController.getProductAddToCartRate.bind(analyticsController)
);
router.get(
    '/rates/abandoned-carts',
    analyticsController.getCartAbandonmentRate.bind(analyticsController)
);
router.get(
    '/costs/acquisitions',
    validateExpenses(),
    validationErrors,
    analyticsController.getCustomerAcquisitionCost.bind(analyticsController)
);
router.get(
    '/carts/populated',
    analyticsController.getPopulatedCarts.bind(analyticsController)
);
